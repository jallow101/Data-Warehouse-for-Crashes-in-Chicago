...
from main import read_csv, write_csv, left_join1, create_date_dimension
...
people_vehicles_data = left_join1(people_data, vehicles_data, 'VEHICLE_ID')
...
final_data = left_join1(people_vehicles_data, crashes_data, 'RD_NO')
